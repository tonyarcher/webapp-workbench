...
describe('Scoring Components', () => {
    ...
    describe('BaseballScoringControls', () => {
        ...
        it('emits view-boxscore from completed state', async () => {
            ...
            let viewed = false;
            element.addEventListener('view-boxscore', () => {
                viewed = true;
            });

            const shadow = element.shadowRoot!;
            const viewBtn = Array.from(shadow.querySelectorAll('.btn')).find((btn) =>
                btn.textContent?.includes('View Final Box Score'),
            ) as HTMLElement;
            viewBtn.click();
    ...
    describe('BaseballScorerTab', () => {
        ...
        it('emits start-new-game-click from empty state button', async () => {
            ...
            let started = false;
            element.addEventListener('start-new-game-click', () => {
                started = true;
            });
        ...
        it('emits open-lineup-setup-click from setup lineups button', async () => {
            ...
            let opened = false;
            element.addEventListener('open-lineup-setup-click', () => {
                opened = true;
            });

            const shadow = element.shadowRoot!;
            const setupBtn = Array.from(shadow.querySelectorAll('.btn-secondary')).find((btn) =>
                btn.textContent?.includes('Setup Lineups'),
            ) as HTMLElement;
            setupBtn.click();
