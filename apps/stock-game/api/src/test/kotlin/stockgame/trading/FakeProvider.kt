...
class FakeProvider(private val bars: List<Bar> = emptyList(), private val quote: Quote? = null) : PriceProvider {
    override val id: String = "fake"

    override fun getQuote(symbol: String): Quote = quote ?: Quote(symbol, symbol, 50.0, "USD", "TEST", 0, 0)
