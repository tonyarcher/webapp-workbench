...
function lineupSlot(random: () => number, usedJerseys: Set<number>, player: LineupLike, index: number) {
    const jersey =
        player.jerseyNumber && player.jerseyNumber > 0 ? player.jerseyNumber : uniqueJersey(random, usedJerseys);
