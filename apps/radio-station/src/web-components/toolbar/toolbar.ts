...
const KNOBS: { key: keyof Weights; label: string; min: number; max: number; title: string }[] = [
    {
        ...
        min: 0,
        max: 100,
        title: 'How hard currents dominate vs deeper recurrents',
    },
    {
        key: 'goldLeak',
        label: 'Gold leak',
        min: 0,
        max: 100,
        title: 'How often 90s/2000s gold interrupts the current clock',
    },
    {
        key: 'temperature',
        label: 'Temperature',
        min: 0,
        max: 100,
        title: 'How much rank can be ignored inside a bucket',
    },
