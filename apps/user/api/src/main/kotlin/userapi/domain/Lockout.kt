...
data class LockoutState(val failedLogins: Int, val lockedUntil: Instant?)

fun isLocked(now: Instant, lockedUntil: Instant?): Boolean = lockedUntil != null && now.isBefore(lockedUntil)
