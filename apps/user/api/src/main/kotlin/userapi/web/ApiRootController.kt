...
class ApiRootController {
    @Operation(summary = "Discover user-api resources (HAL)")
    ...
    fun root(): RootLinks {
        ...
        model.add(Link.of("/csrf", "csrf"))
        model.add(Link.of("/me", "me"))
        model.add(Link.of("/oauth/authorize", "oauth-authorize"))
        model.add(Link.of("/oauth/jwks", "oauth-jwks"))
