...
// short links skipped
{
    ...
    assert(
        r.skipped.every((s) => s.reason === 'short-link'),
        'short-link reasons',
    );
}
...
{
    const r = parseLinkList('https://www.tiktok.com/@a/video/202020\nhttps://www.instagram.com/reel/MixEdClip01/');
...
{
    const r = parseLinkList(
        '{"saved_saved_media":[{"string_list_data":[{"href":"https://www.instagram.com/reel/JsonCode01/"}]}]}',
    );
...
// session persist / restore
{
    const session = {
        ...
        items: [
            {
                id: '1',
                url: 'https://www.tiktokv.com/share/video/1/',
                date: '2026-01-01',
